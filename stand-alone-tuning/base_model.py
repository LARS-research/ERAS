...
class BaseModel(object):
    def __init__(self, n_ent, n_rel, args, rela_cluster, tester_val, tester_tst, tester_trip):
    ...
    def train_stand(self, train_data, valid_data, derived_struct, rela_cluster, mrr):
        ...
        for epoch in range(self.args.n_epoch):
            ...
            print("Epoch: %d/%d, Stand Time=%.2f, Loss=%.2f"%(epoch+1, self.args.n_epoch, time.time()-start, epoch_loss/n_train))
